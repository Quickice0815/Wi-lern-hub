...
export const WorkedExamples: Record<string, WorkedExampleDataT> = {
  jaccard: {
    ...
    practiceSet: [
      ...
      {
        n: 3,
        textA: 'die neue app funktioniert sehr gut',
        textB: 'die neue app funktioniert ziemlich schlecht',
        shinglesA: ['die neue app', 'neue app funktioniert', 'app funktioniert sehr', 'funktioniert sehr gut'],
        shinglesB: ['die neue app', 'neue app funktioniert', 'app funktioniert ziemlich', 'funktioniert ziemlich schlecht'],
        distractors: ['neue die app', 'app die neue', 'sehr gut app', 'funktioniert app neue', 'schlecht ziemlich funktioniert'],
        sharedShingles: ['die neue app', 'neue app funktioniert'],
        jaccardPercent: 33,
      },
      {
        n: 3,
        textA: 'wir versenden die bestellung heute noch',
        textB: 'wir versenden die ware heute noch',
        shinglesA: ['wir versenden die', 'versenden die bestellung', 'die bestellung heute', 'bestellung heute noch'],
        shinglesB: ['wir versenden die', 'versenden die ware', 'die ware heute', 'ware heute noch'],
        distractors: ['die versenden wir', 'bestellung wir versenden', 'heute die bestellung', 'ware bestellung heute', 'noch heute ware'],
        sharedShingles: ['wir versenden die'],
        jaccardPercent: 14,
      },
      {
        n: 4,
        textA: 'der kunde bestellt heute drei artikel',
        textB: 'der kunde bestellt heute zwei artikel',
        shinglesA: ['der kunde bestellt heute', 'kunde bestellt heute drei', 'bestellt heute drei artikel'],
        shinglesB: ['der kunde bestellt heute', 'kunde bestellt heute zwei', 'bestellt heute zwei artikel'],
        distractors: ['kunde der bestellt heute', 'heute kunde bestellt der', 'drei artikel bestellt kunde', 'zwei kunde bestellt heute'],
        sharedShingles: ['der kunde bestellt heute'],
        jaccardPercent: 20,
      },
      {
        n: 4,
        textA: 'wir bearbeiten ihre anfrage sehr schnell',
        textB: 'wir bearbeiten ihre anfrage sehr genau',
        shinglesA: ['wir bearbeiten ihre anfrage', 'bearbeiten ihre anfrage sehr', 'ihre anfrage sehr schnell'],
        shinglesB: ['wir bearbeiten ihre anfrage', 'bearbeiten ihre anfrage sehr', 'ihre anfrage sehr genau'],
        distractors: ['bearbeiten wir ihre anfrage', 'ihre wir bearbeiten anfrage', 'anfrage sehr schnell ihre', 'genau sehr anfrage ihre'],
        sharedShingles: ['wir bearbeiten ihre anfrage', 'bearbeiten ihre anfrage sehr'],
        jaccardPercent: 50,
      },
      {
        n: 4,
        textA: 'der himmel ist heute sehr blau',
        textB: 'das wasser ist heute recht kalt',
        shinglesA: ['der himmel ist heute', 'himmel ist heute sehr', 'ist heute sehr blau'],
        shinglesB: ['das wasser ist heute', 'wasser ist heute recht', 'ist heute recht kalt'],
        distractors: ['himmel der ist heute', 'heute ist himmel sehr', 'blau sehr heute ist', 'wasser das ist heute', 'kalt recht heute ist'],
        sharedShingles: [],
        jaccardPercent: 0,
      },
    ],
